...
public class FontSliderBar extends View {
	...
	private int[] mTextSizes = new int[]{30,33,36,39};
	private String[] mTextNames = new String[]{"小","标准","大","加大"};
	private int mTextColor = DEFAULT_TEXT_COLOR;
	private int mTextPadding = DEFAULT_TEXT_PADDING;

	private int mDefaultWidth = 520;
	...
	public FontSliderBar setTextSizes(int[] textSizes) {
	...
	private void createBar() {
		mBar = new Bar(getXCoordinate(), getYCoordinate(), getBarLength(), mTickCount, mTickHeight, mBarWidth,
				mBarColor, mTextColor, mTextSizes, mTextPadding, mTextNames);
	}
