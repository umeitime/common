package com.umeitime.common.views.citypickerview.widget;
...
import com.umeitime.common.views.citypickerview.model.CityModel;
import com.umeitime.common.views.citypickerview.model.DistrictModel;
import com.umeitime.common.views.citypickerview.model.ProvinceModel;
import com.umeitime.common.views.citypickerview.utils.XmlParserHandler;
import com.umeitime.common.views.citypickerview.widget.wheel.OnWheelChangedListener;
import com.umeitime.common.views.citypickerview.widget.wheel.WheelView;
import com.umeitime.common.views.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
     ...
     * 第一次默认得显示，一般配合定位，使用
     */
    private String defaultDistrict = "西湖区";
    ...
    private CityPicker(Builder builder) {
        ...
        popwindow.setAnimationStyle(R.style.BottomAnim);
