...
package com.umeitime.common.views.citypickerview.widget.wheel;
...
import com.umeitime.common.views.citypickerview.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
     ...
     */
    private int[] SHADOWS_COLORS = new int[]{0xefFAFAFA,
            0xcfFAFAFA, 0x3fFAFAFA};
