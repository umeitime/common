...
public class MaterialProgressView extends View {
    ...
    private static final int BORDER_WIDTH_DEFAULT = 6;

    private int[] mPaintColors;
    private static final int[] COLORS_DEFAULT = new int[]{
            0xff02bbfe,0xff02bbfe,0xff02bbfe,0xff02bbfe
    };

    private int mAngleDuration;
    private static final int ANGLE_DURATION_DEFAULT = 800;

    private int mSweepDuration;
    private static final int SWEEP_DURATION_DEFAULT = 800;
