...
public abstract class BaseInnerListActivity<P extends BasePresenter, T> extends BaseActivity implements IBaseListView<T>, SwipeRefreshLayout.OnRefreshListener, InnerScrollerContainer {
